  ...
  const providerSchema = Joi.object({
    serviceType: Joi.string()
      ...
      .messages({
        ...
        "any.required": "Service type required",
      }),
    ...
    priceRange: Joi.string().trim().min(1).max(50).required().messages({
          ...
          {formik.errors.priceRange && (
            ...
            <input
              ...
              onChange={(e) => {
                ...
                formik.setFieldValue("contact", "+91" + digits);
              }}
              onKeyDown={(e) => {
                if (
                  (e.key === "Backspace" || e.key === "Delete") &&
                  formik.values.contact.length <= 3
                ) {
                  e.preventDefault();
                }
              }}
                      ...
                      return (
                        ...
                        >
                          <div>
                            ...
                            />
                            {formik.errors[
                              `servicesOffered.${gi}.subServices.${si}.service`
                            ] && (
                              <p className="text-xs text-red-600 mt-1">
                                {
                                  formik.errors[
