    ...
    <main className="min-h-screen w-full bg-white px-4 py-10 flex items-start justify-center">
      <div className="w-full max-w-6xl">
          ...
          <div className="border-t border-orange-100 bg-orange-50/50 px-6 py-5">
            <form className="flex flex-col lg:flex-row items-stretch gap-3 lg:gap-4 justify-between">
              <div className="flex flex-wrap gap-3 flex-1">
                <FilterInput icon={<Dog className="h-4 w-4 text-orange-500" />} label="I'm looking for" value="Dog Boarding" />
                <FilterInput icon={<MapPin className="h-4 w-4 text-orange-500" />} label="Location" value="Enter city / pincode" />
                <FilterInput icon={<Calendar className="h-4 w-4 text-orange-500" />} label="Dates" value="Select dates" />
                <FilterInput icon={<PawPrint className="h-4 w-4 text-orange-500" />} label="Pet size" value="Small (0-15 kg)" />
              </div>

              <div className="flex items-center lg:items-stretch">
                <Button type="submit" className="flex items-center gap-2 rounded-full bg-orange-600 hover:bg-orange-700 px-5 py-2 text-white">
        ...
        <section className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          <FeatureCard title="Trusted Professionals" desc="Background-checked vets, groomers & boarding" />
          <FeatureCard title="Easy Booking" desc="Book instantly, pay securely" />
          <FeatureCard title="24/7 Support" desc="We're here whenever you need us" />
        </section>
